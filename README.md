...
### 예외
- 중복되는 수를 입력받을 경우 IllegalArgumentException을 발생시킨다.
- 숫자 외 다른 수를 입력받을 경우 IllegalArgumentException을 발생시킨다.
- 3자리가 아닐 경우 IllegalArgumentException을 발생시킨다.
- 재시작 시 1, 2 외의 수를 입력 받을 경우 IllegalArgumentException을 발생시킨다.
